            ...
            <div class="updated notice notice-get-started-class is-dismissible" data-notice="get_started">
                <div class="blogone-getting-started-notice clearfix">
                    ...
                    <div class="blogone-theme-notice-content">
                        ...
                        <a class="blogone-btn-get-started button button-primary button-hero blogone-button-padding" href="#" data-name="" data-slug=""><?php _e( 'Get started with Blogone', 'blogone' ) ?></a>
                        <?php
                            /* translators: %1$s: Anchor link start %2$s: Anchor link end */
                            printf(
                                'OR %1$sUpgrade To Blogone Pro%2$s</a></span>',
                                '<a class="button button-danger button-hero blogone-button-padding" target="_blank" href="https://www.britetechs.com/theme/blogone-pro/">',
                                '</a>'
                            );
                        ?>
